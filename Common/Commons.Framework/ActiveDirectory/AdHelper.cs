// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AdHelper.cs" company="Usama Nada">
...
/*
 TODO: RENAME GROUP CODE
 http://stackoverflow.com/questions/13365708/groupprincipal-rename-group
    ...
    public class AdHelper
    {
            ...
            bool isActive = true)
        {
            if (!this.IsUserExisiting(sUserName))
            {
                ...
                var oUserPrincipal =
                    new UserPrincipal(oPrincipalContext, sUserName, sPassword, isActive)
                        {
                            UserPrincipalName =
                                sUserName,
