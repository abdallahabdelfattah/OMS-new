...
// USAMA NADA
// I CHANGED THE DATE VALIDATION RANGE TO BE MORE FLEXIBLE AND USABLE .. ENJOY
    ...
    $.extend(UmmAlQuraCalendar.prototype, {
        ...
        isValid: function (year, month, day) { // jshint unused:false
            ...
            if (valid) {
                ...
                // USAMA NADA These Values are modified for usability.
                valid = (year >= 1000 && year <= 2500);
            }
            return valid;
        },
        ...
        _validate: function (year, month, day, error) {
           ...
           // console.log('year: ' + year + ' month:' + month, ' day:' + day + ' error:' + error);
            // USAMA NADA These Values are modified for usability.
            if (date.year < 1000 || date.year > 2500) {
