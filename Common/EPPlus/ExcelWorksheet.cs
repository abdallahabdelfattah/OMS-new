  ...
  public enum eWorkSheetHidden
    ...
    public class ExcelWorksheet : XmlHelper, IEqualityComparer<ExcelWorksheet>, IDisposable
    {
        ...
        private void CreateXml()
        {
            ...
            // First Columns, rows, cells, mergecells, hyper-links and pagebreakes are loaded from a xmlstream to optimize speed...
        ...
        /// Xml-Cell data can be extremely large (GB), so we find the sheetdata element in the stream (position start) and 
...
//                            newFormulas[newFormulas.Count - 1].Address = ExcelCellBase.GetAddress(newFormulas[newFormulas.Count - 1].StartRow, newFormulas[0].StartCol, row - 1, col);
        ...
        /// <summary>
        /// Delete the printer settings relationship and part.
        /// </summary>
        ...
        /// <summary>
        /// Create the hyper-links node in the XML
        /// </summary>
        /// <returns></returns>
...
#region Drawing
        ...
        /// Shared formulas will have an id from 0-x. Array formula ids start from 0x4000001-. 
        /// </summary>
