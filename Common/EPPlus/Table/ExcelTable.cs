...
namespace OfficeOpenXml.Table
{
    ...
    public class ExcelTable : XmlHelper, IEqualityComparer<ExcelTable>
    {
        ...
        /// <summary>
        /// The table style. If this property is custom, the style from the StyleName property is used.
        /// </summary>
        ...
        /// <summary>
        /// If the header row has an auto-filter
        /// </summary>
        [Obsolete]
        ...
        /// <summary>
        /// The style name for custom styles
        /// </summary>
