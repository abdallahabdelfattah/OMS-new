...
namespace OMS.BLL.Data
{
    ...
    public static class Extensions
    {
        ...
        ///     and looks for fields of the same name in the source row. Structure must math
        ...
        public static bool IsDirty(this DbContext context)
        {
            ...
            var res = from e in context.ChangeTracker.Entries()
                      where e.State.HasFlag(System.Data.Entity.EntityState.Added) || e.State.HasFlag(System.Data.Entity.EntityState.Modified)
                            || e.State.HasFlag(System.Data.Entity.EntityState.Deleted)
                      select e;
