...
{
    public partial class MedicalLensMasterRepository : RepositoryBase<MedicalLensMaster>
    {
        public MedicalLensMasterRepository(DbContext context)
            : base(context)
        {
        }
    }
    ...
    public partial class MedicalLensMasterRepository : RepositoryBase<MedicalLensMaster>
    {
        public PagedList<MedicalLensMaster> Search(MedicalLensMasterSearchViewModel vm)
        {
