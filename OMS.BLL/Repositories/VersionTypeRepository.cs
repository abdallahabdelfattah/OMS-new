...
{
    public class VersionTypeRepository : RepositoryBase<VersionType>
    {
        public VersionTypeRepository(DbContext context) : base(context)
        {
        }
        public PagedList<VersionType> Search(VersionTypeSearchViewModel sc)
        {
