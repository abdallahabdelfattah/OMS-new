...
namespace OMS.Web.Globalization
{
    ...
    public static class CultureHelper
    {
        ...
        public static string CurrentLang => Thread.CurrentThread.CurrentCulture.LCID == 1025?"ar":"en";
        ...
        public static void InitializeCultureFromCookie()
        {
            ...
            const string CookieName = "oms-user-culture";
        ...
        {
            var defaultCulture = "ar-SA";
            var englishCulture = "en-US";
            const string CookieName = "oms-user-culture";

            var cultureCookie =HttpContext.Current.Request.Cookies[CookieName];
            if (cultureCookie.Value.Equals(defaultCulture))
            {
                cultureCookie =
                    new HttpCookie(
                        CookieName,
                        englishCulture.ToString(CultureInfo.InvariantCulture))
                    {
                        Expires = DateTime.Now.AddYears(1)
                    };
            }
